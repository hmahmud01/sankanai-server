            ...
            <div class="uk-width-1-4@m uk-text-left">
                ...
                <ul uk-accordion>
                    <li>
                        ...
                        <div class="uk-accordion-content">
                            <a class="uk-button uk-button-default uk-width-1-1@s uk-margin-small-bottom" href="{{ route('gallery.sorted')}}">Sort Alphabetically A-Z</a>
                            <a class="uk-button uk-button-default uk-width-1-1@s uk-margin-small-bottom" href="{{ route('gallery.gallerysortedreverse')}}">Sort Alphabetically Z-A</a>
                            <a class="uk-button uk-button-default uk-width-1-1@s uk-margin-small-bottom" href="{{ route('gallery.gallerypricesorted')}}">Sort Price Low-High </a>
                            <a class="uk-button uk-button-default uk-width-1-1@s uk-margin-small-bottom" href="{{ route('gallery.gallerypricesortedreverse')}}">Sort Price High-Low </a>
                        </div>
                    </li>
                </ul>                
            </div>
